...
public class PopMenu implements OnItemClickListener
{
    ...
    public PopMenu(Context context)
    {
        ...
        popupWindow = new PopupWindow(view, // getDimensionPixelSize方法实际上是把dimens.xml中设置的cellWidth大小由dp转换成px！
                context.getResources().getDimensionPixelSize(
                        R.dimen.popmenu_width), // 这里宽度需要自己指定，使用 WRAP_CONTENT
                                                // 会很大
                context.getResources().getDimensionPixelSize(
                        R.dimen.popmenu_heigth));
    ...
    public void showAsDropDown(View parent)
    {
        popupWindow.showAsDropDown(
                parent,
                (parent.getWidth() - popupWindow.getWidth()) / 2,
                // 保证尺寸是根据屏幕像素密度来的
                context.getResources().getDimensionPixelSize(
